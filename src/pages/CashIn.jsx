...
const CashIn = () => {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 md:items-center h-screen justify-center bg-[#ff7e67]">
      <div className="flex-col items-center pt-[30%] md:pt-0 text-center md:text-start text-white md:ml-[20%] space-y-4 md:space-y-12">
        ...
        <p className="font-semibold  md:text-xl">
          Enjoy Unlimited Cash In Without Any Fee
        </p>
      </div>
      <div>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="max-w-[75%] mx-auto space-y-10">
            ...
            <div className="flex justify-center">
              <button className="btn bg-[#155263] text-white py-2 px-4 rounded-lg">
                Confirm
              </button>
            </div>
          </div>
