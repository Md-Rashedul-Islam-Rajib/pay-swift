...
const Login = () => {
  ...
  return (
    <section className=" bg-[#115263] h-full w-screen pb-[20%]">
      ...
      <div className="flex justify-center items-center h-full">
        <form
          ...
          className="bg-slate-400 p-6 rounded-lg text-white"
        >
          {showEmail ? (
            <div>
          ...
          <button
            className="text-[#155263] font-semibold my-4"
            type="button"
            onClick={toggleInput}
          >
            Use {showEmail ? "Mobile Number" : "Email"} Instead
          </button>
        </form>
      </div>
    </section>
